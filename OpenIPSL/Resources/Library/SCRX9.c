...
// ----------------------------------------------------------------
__declspec(dllexport) void __cdecl update_scrx_input(IEEE_Cigre_DLLInterface_Instance* instance,double sim_time_input, double vref,double ec,
